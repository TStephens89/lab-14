...
function updateCounter() { 
  ...
  count.textContent = (`the number of items in the Cart is ${cart.items.length}`);
...
function updateCartPreview() {
  ...
  text1.textContent = (`You have ${item} Quantity: ${amount}`)
  // TODO: Add a new element to the cartContents div with that information
  let divInfo = document.getElementById('cartContents');
  divInfo.appendChild(text1);
}
